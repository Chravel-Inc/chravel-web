...
export const AIConciergeChat = ({
  ...
  return (
    <div className="flex flex-col overflow-hidden flex-1 min-h-0 h-full min-w-0 px-3 pb-2">
      <div className="rounded-2xl border border-white/10 bg-black/40 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] overflow-hidden flex flex-col flex-1 min-w-0">
