...
export const TripStatsOverview = ({
  ...
  const getStatButtonClass = (filterType: string) => {
    const baseClass =
      'inline-flex items-center gap-1 cursor-pointer transition-all duration-200 px-2 py-1.5 rounded-full hover:bg-secondary/50';
    return activeFilter === filterType ? `${baseClass} bg-secondary/80` : baseClass;
  };
