...
describe('Google Places New API Service', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    // Reset quota monitor
    (apiQuotaMonitor as unknown).dailyRequests.clear();
    (apiQuotaMonitor as unknown).hourlyRequests.clear();
    (apiQuotaMonitor as unknown).cachedResults.clear();
  });
  ...
  describe('API Quota Monitor', () => {
    ...
    it('should return null for expired cache', () => {
      ...
      const cached = (apiQuotaMonitor as unknown).cachedResults.get(cacheKey);
