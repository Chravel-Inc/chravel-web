...
const landmarkImage = (query: string) =>
...
export const landmarkRecommendations: Recommendation[] = [
  {
    ...
    rating: 4.8,
    priceLevel: 1,
    images: [landmarkImage('Hollywood Sign Los Angeles')],
  ...
  },
  {
    ...
    rating: 4.9,
    priceLevel: 2,
    images: [landmarkImage('Pyramids of Giza Egypt')],
  ...
  },
  {
    ...
    rating: 4.7,
    priceLevel: 1,
    images: [landmarkImage('Templo Mayor Mexico City ruins')],
  ...
  },
  {
    ...
    rating: 4.8,
    priceLevel: 3,
    images: [landmarkImage('Eiffel Tower Paris')],
  ...
  },
  {
    ...
    rating: 4.8,
    priceLevel: 2,
    images: [landmarkImage('Sydney Opera House')],
