...
export const eliLillyCsuiteRetreat: ProTripData = {
  ...
  description:
    'Executive strategic planning retreat at Terranea Resort for senior leadership team.',
  ...
  broadcasts: [
    ...
    },
    {
      ...
      senderId: '11',
      message:
        'REMINDER: All executives please review pre-read materials before tomorrow morning session.',
      targetTrips: ['eli-lilly-c-suite-retreat-2026'],
      priority: 'urgent',
  ...
  participants: [
    ...
    },
    {
      id: '11',
      name: 'Patrik Jonsson',
      avatar: getMockAvatar('Patrik Jonsson'),
      role: 'Executives',
    },
    {
      id: '12',
      name: 'Dan Skovronsky',
      avatar: getMockAvatar('Dan Skovronsky'),
      role: 'Executives',
    },
    ...
    { id: '14', name: 'Ilya Yuffa', avatar: getMockAvatar('Ilya Yuffa'), role: 'Executives' },
    {
      ...
      avatar: getMockAvatar('Jake Van Naarden'),
      role: 'Executives',
    },
    ...
    {
      id: '19',
      name: 'Regional VP North America',
      avatar: getMockAvatar('Regional VP North America'),
      role: 'VPs',
    },
    {
      id: '20',
      name: 'Regional VP Europe',
      avatar: getMockAvatar('Regional VP Europe'),
      role: 'VPs',
    },
    {
      id: '21',
      name: 'Regional VP Asia Pacific',
      avatar: getMockAvatar('Regional VP Asia Pacific'),
      role: 'VPs',
    },
    {
      id: '22',
      name: 'SVP R&D Operations',
      avatar: getMockAvatar('SVP R&D Operations'),
      role: 'VPs',
    },
    {
      id: '23',
      name: 'SVP Manufacturing',
      avatar: getMockAvatar('SVP Manufacturing'),
      role: 'VPs',
    },
    {
      id: '24',
      name: 'SVP Global Marketing',
      avatar: getMockAvatar('SVP Global Marketing'),
      role: 'VPs',
    },
    {
      id: '25',
      name: 'Chief Medical Officer',
      avatar: getMockAvatar('Chief Medical Officer'),
      role: 'VPs',
    },
    {
      id: '26',
      name: 'Chief Information Officer',
      avatar: getMockAvatar('Chief Information Officer'),
      role: 'VPs',
    },
    {
      id: '27',
      name: 'Chief People Officer',
      avatar: getMockAvatar('Chief People Officer'),
      role: 'VPs',
    },
    {
      id: '28',
      name: 'Chief Scientific Officer',
      avatar: getMockAvatar('Chief Scientific Officer'),
      role: 'VPs',
    },
    {
      id: '29',
      name: 'Director Global Strategy',
      avatar: getMockAvatar('Director Global Strategy'),
      role: 'Directors',
    },
    {
      id: '30',
      name: 'Director Innovation',
      avatar: getMockAvatar('Director Innovation'),
      role: 'Directors',
    },
    {
      id: '31',
      name: 'Director Business Development',
      avatar: getMockAvatar('Director Business Development'),
      role: 'Directors',
    },
    {
      id: '32',
      name: 'Director Corporate Affairs',
      avatar: getMockAvatar('Director Corporate Affairs'),
      role: 'Directors',
    },
    {
      id: '33',
      name: 'Director Regulatory Affairs',
      avatar: getMockAvatar('Director Regulatory Affairs'),
      role: 'Directors',
    },
    {
      id: '34',
      name: 'Director Quality Assurance',
      avatar: getMockAvatar('Director Quality Assurance'),
      role: 'Directors',
    },
    {
      id: '35',
      name: 'Strategic Planner 1',
      avatar: getMockAvatar('Strategic Planner 1'),
      role: 'Coordinators',
    },
    {
      id: '36',
      name: 'Strategic Planner 2',
      avatar: getMockAvatar('Strategic Planner 2'),
      role: 'Coordinators',
    },
    {
      id: '37',
      name: 'Executive Assistant 1',
      avatar: getMockAvatar('Executive Assistant 1'),
      role: 'Support Staff',
    },
    {
      id: '38',
      name: 'Executive Assistant 2',
      avatar: getMockAvatar('Executive Assistant 2'),
      role: 'Support Staff',
    },
    {
      id: '39',
      name: 'Facilities Coordinator',
      avatar: getMockAvatar('Facilities Coordinator'),
      role: 'Support Staff',
    },
    {
      id: '40',
      name: 'AV Tech Support',
      avatar: getMockAvatar('AV Tech Support'),
      role: 'Support Staff',
    },
  ],
  budget: {
      ...
      events: [
        {
          ...
          location: 'Terranea Resort - Ocean View Room',
          type: 'meeting',
        },
        {
          time: '10:30',
          title: '2026 Strategic Planning Session',
