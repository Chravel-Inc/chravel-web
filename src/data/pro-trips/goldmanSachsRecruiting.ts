...
export const goldmanSachsRecruiting: ProTripData = {
  ...
  description:
    'Campus recruiting visit to Georgia Tech featuring CEO keynote and networking events.',
  location: 'Atlanta, GA',
  ...
  participants: [
    ...
    { id: '2', name: 'Rachel Ma', avatar: getMockAvatar('Rachel Ma'), role: 'Campus Lead' },
    {
      id: '3',
      name: 'Luis Vargas',
      avatar: getMockAvatar('Luis Vargas'),
      role: 'Analyst Panelist',
    },
    {
      id: '4',
      name: 'Priya Dhillon',
      avatar: getMockAvatar('Priya Dhillon'),
      role: 'HR Coordinator',
    },
  ],
  roster: [
    {
      ...
      name: 'David Solomon',
      role: 'CEO Speaker',
      email: 'david.solomon@example.com',
      avatar: getMockAvatar('David Solomon'),
    ...
    },
    {
      ...
      name: 'Rachel Ma',
      role: 'Campus Lead',
      email: 'rachel.ma@example.com',
      avatar: getMockAvatar('Rachel Ma'),
    ...
    },
    {
      ...
      name: 'Priya Dhillon',
      role: 'HR Coordinator',
      email: 'priya.dhillon@example.com',
      avatar: getMockAvatar('Priya Dhillon'),
