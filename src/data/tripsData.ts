...
export const tripsData: Trip[] = [
  ...
  // ⚠️ DEMO DATA — peopleCount is authoritative. Do not auto-derive or use fallbacks.
  {
    ...
    participants: Array.from({ length: 63 }, (_, i) => {
      ...
      if (i < 12) {
        ...
        return {
          id: i + 1,
          name: brideFamily[i - 2] || `Bride Family ${i - 1}`,
          avatar: getMockAvatar(brideFamily[i - 2] || `Guest${i}`),
        };
      }
      if (i < 22) {
        const groomFamily = [
        ...
        return {
          id: i + 1,
          name: groomFamily[i - 12] || `Groom Family ${i - 11}`,
          avatar: getMockAvatar(groomFamily[i - 12] || `Guest${i}`),
        };
      }
  ...
  },
  {
    ...
    participants: Array.from({ length: 34 }, (_, i) => {
      ...
      return {
        id: 32 + i,
        name: names[i] || `Wellness Guest ${i + 1}`,
        avatar: getMockAvatar(names[i] || `Guest${i}`),
      };
    }),
  },
  {
  ...
  },
  {
    ...
    participants: Array.from({ length: 44 }, (_, i) => {
      ...
      return {
        ...
        avatar: getMockAvatar(names[i] || `Employee${i}`),
      };
    }),
  },
  {
...
const getCitySpecificLinks = (location: string) => {
  ...
  const linkTemplates: Record<
    string,
    Array<{ title: string; url: string; category: string; domain: string; description: string }>
  > = {
    Cancun: [
      {
        title: 'Live Aqua Beach Resort Cancun',
        url: 'https://www.liveaqua.com/cancun',
        category: 'Accommodation',
        domain: 'liveaqua.com',
        description: 'Adults-only all-inclusive beachfront resort',
      },
      {
        title: 'Cenote Dos Ojos Snorkeling & Cave Diving',
        url: 'https://www.cenotedosojos.com/',
        category: 'Activity',
        domain: 'cenotedosojos.com',
        description: 'Underground cave system snorkeling tours',
      },
      {
        title: 'La Parrilla - Authentic Mexican Cuisine',
        url: 'https://www.laparrilla.com.mx/',
        category: 'Appetite',
        domain: 'laparrilla.com.mx',
        description: 'Traditional Yucatecan dishes and live mariachi',
      },
      {
        title: 'Chichén Itzá Archaeological Site',
        url: 'https://www.inah.gob.mx/zonas/146-zona-arqueologica-de-chichen-itza',
        category: 'Attraction',
        domain: 'inah.gob.mx',
        description: 'Ancient Mayan pyramid and UNESCO World Heritage site',
      },
    ],
    Tokyo: [
      {
        ...
        category: 'Accommodation',
        domain: 'hyatt.com',
        description: 'Luxury hotel in Shinjuku with skyline views',
      },
      {
        ...
        category: 'Activity',
        domain: 'teamlab.art',
        description: 'Immersive interactive digital art experience',
      },
      {
        title: 'Sukiyabashi Jiro Sushi Restaurant',
        url: 'https://www.sushi-jiro.jp/',
        category: 'Appetite',
        domain: 'sushi-jiro.jp',
        description: 'Three-Michelin-star sushi by master chef',
      },
      {
    ...
    Bali: [
      {
        title: 'Mulia Bali Resort',
        url: 'https://www.themulia.com/mulia-bali',
        category: 'Accommodation',
        domain: 'themulia.com',
      ...
      },
      {
        ...
        url: 'https://www.balihai-cruises.com/batur',
        category: 'Activity',
        domain: 'balihai-cruises.com',
        description: 'Guided volcano trek with sunrise views',
      },
      {
        title: 'Locavore Restaurant Ubud',
        url: 'https://www.locavore.co.id/',
        category: 'Appetite',
        domain: 'locavore.co.id',
        description: 'Farm-to-table Indonesian fine dining',
      },
      {
        title: 'Tirta Empul Water Temple',
        url: 'https://www.bali.com/tirta-empul-temple.html',
        category: 'Attraction',
        domain: 'bali.com',
        description: 'Sacred Balinese Hindu water temple',
      },
    ],
    Nashville: [
      {
        title: 'The Hermitage Hotel',
        url: 'https://www.thehermitagehotel.com/',
        category: 'Accommodation',
        domain: 'thehermitagehotel.com',
        description: 'Historic luxury hotel in downtown Nashville',
      },
      {
        title: 'Grand Ole Opry VIP Tour',
        url: 'https://www.opry.com/tour',
        category: 'Activity',
        domain: 'opry.com',
        description: 'Backstage tour of country music landmark',
      },
      {
        title: "Hattie B's Hot Chicken",
        url: 'https://www.hattieb.com/',
        category: 'Appetite',
        domain: 'hattieb.com',
        description: 'Famous Nashville hot chicken restaurant',
      },
      {
        ...
        description: 'Museum celebrating country music history',
      },
    ],
    Indio: [
      {
        ...
        category: 'Accommodation',
        domain: 'laquintaresort.com',
        description: 'Luxury desert resort near festival grounds',
      },
      {
        title: 'Hot Air Balloon Ride Palm Desert',
        url: 'https://www.fantasticballoons.com/',
        category: 'Activity',
        domain: 'fantasticballoons.com',
        description: 'Scenic balloon flights over Coachella Valley',
      },
      {
        title: 'Tac/Quila Mexican Restaurant',
        url: 'https://tacquila.com/',
        category: 'Appetite',
        domain: 'tacquila.com',
        description: 'Upscale Mexican cuisine with desert views',
      },
      {
        ...
        category: 'Attraction',
        domain: 'nps.gov',
        description: 'Iconic desert landscape with unique rock formations',
      },
    ],
    Dubai: [
      {
        title: 'Burj Al Arab Jumeirah',
        url: 'https://www.jumeirah.com/burj-al-arab',
        category: 'Accommodation',
        domain: 'jumeirah.com',
      ...
      },
      {
        ...
        category: 'Activity',
        domain: 'arabian-adventures.com',
        description: 'Dune bashing and traditional Bedouin camp',
      },
      {
        title: 'Nobu Dubai',
        url: 'https://www.noburestaurants.com/dubai',
        category: 'Appetite',
        domain: 'noburestaurants.com',
        description: 'World-famous Japanese-Peruvian fusion',
      },
      {
    ...
    Phoenix: [
      {
        title: 'The Phoenician Resort',
        url: 'https://www.thephoenician.com/',
        category: 'Accommodation',
        domain: 'thephoenician.com',
        description: 'Luxury Scottsdale resort at Camelback Mountain',
      },
      {
        title: 'TPC Scottsdale Golf Course',
        url: 'https://www.tpc.com/scottsdale',
        category: 'Activity',
        domain: 'tpc.com',
        description: 'Championship golf course hosting PGA Tour',
      },
      {
        title: 'Steak 44',
        url: 'https://www.steak44.com/',
        category: 'Appetite',
        domain: 'steak44.com',
        description: 'Premier Phoenix steakhouse experience',
      },
      {
        ...
        category: 'Attraction',
        domain: 'dbg.org',
        description: 'Stunning desert plant collections and trails',
      },
    ],
    Tulum: [
      {
        ...
        category: 'Accommodation',
        domain: 'azulik.com',
        description: 'Eco-luxury treehouse resort on the beach',
      },
      {
        title: 'Gran Cenote Swimming',
        url: 'https://grancenote.com/',
        category: 'Activity',
        domain: 'grancenote.com',
        description: 'Crystal-clear cenote swimming and snorkeling',
      },
      {
        title: 'Hartwood Restaurant',
        url: 'https://www.hartwoodtulum.com/',
        category: 'Appetite',
        domain: 'hartwoodtulum.com',
        description: 'Farm-to-table dining by candlelight',
      },
      {
        title: 'Tulum Archaeological Zone',
        url: 'https://www.inah.gob.mx/zonas/zona-arqueologica-de-tulum',
        category: 'Attraction',
        domain: 'inah.gob.mx',
        description: 'Mayan ruins overlooking the Caribbean Sea',
      },
    ],
    'Napa Valley': [
      {
        ...
        category: 'Accommodation',
        domain: 'meadowood.com',
        description: 'Luxury estate resort in wine country',
      },
      {
        title: 'Hot Air Balloon Over Vineyards',
        url: 'https://www.balloonrides.com/napa',
        category: 'Activity',
        domain: 'balloonrides.com',
        description: 'Sunrise balloon flight with champagne toast',
      },
      {
        ...
        description: 'Three-Michelin-star culinary experience',
      },
      {
        ...
        description: 'Iconic Napa winery with premium tastings',
      },
    ],
    Aspen: [
      {
        ...
        description: 'Ski-in/ski-out luxury at base of Aspen Mountain',
      },
      {
        title: 'Aspen Skiing Company Lessons',
        url: 'https://www.aspensnowmass.com/lessons',
        category: 'Activity',
        domain: 'aspensnowmass.com',
        description: 'Expert ski and snowboard instruction',
      },
      {
        title: 'Matsuhisa Aspen',
        url: 'https://www.noburestaurants.com/matsuhisa-aspen',
        category: 'Appetite',
        domain: 'noburestaurants.com',
        description: "Nobu's original mountain Japanese restaurant",
      },
      {
        title: 'Maroon Bells',
        url: 'https://www.aspenchamber.org/maroon-bells',
        category: 'Attraction',
        domain: 'aspenchamber.org',
        description: "Colorado's most photographed peaks",
      },
    ],
    'Port Canaveral': [
      {
        title: 'Cape Canaveral Beach Resort',
        url: 'https://www.capecanaveralbeachresort.com/',
        category: 'Accommodation',
        domain: 'capecanaveralbeachresort.com',
        description: 'Oceanfront resort near cruise port',
      },
      {
        ...
        description: 'NASA space exploration experience',
      },
      {
        title: 'Grills Seafood Deck',
        url: 'https://www.grillsseafood.com/',
        category: 'Appetite',
        domain: 'grillsseafood.com',
        description: 'Waterfront fresh seafood and rocket views',
      },
      {
        title: 'Exploration Tower',
        url: 'https://www.explorationtower.com/',
        category: 'Attraction',
        domain: 'explorationtower.com',
        description: '7-story observation tower with port views',
      },
    ],
    Yellowstone: [
      {
        title: 'Old Faithful Inn',
        url: 'https://www.yellowstonenationalparklodges.com/lodgings/hotel/old-faithful-inn/',
        category: 'Accommodation',
        domain: 'yellowstonenationalparklodges.com',
        description: 'Historic lodge overlooking Old Faithful geyser',
      },
      {
        title: 'Yellowstone Wildlife Safari',
        url: 'https://www.yellowstonesafari.com/',
        category: 'Activity',
        domain: 'yellowstonesafari.com',
        description: 'Guided wildlife viewing and photography tours',
      },
      {
        title: 'Lake Yellowstone Hotel Dining Room',
        url: 'https://www.yellowstonenationalparklodges.com/dine/lake-yellowstone-hotel-dining-room/',
        category: 'Appetite',
        domain: 'yellowstonenationalparklodges.com',
        description: 'Elegant lakeside dining in the park',
      },
      {
        title: 'Grand Prismatic Spring',
        url: 'https://www.nps.gov/yell/planyourvisit/grand-prismatic-spring.htm',
        category: 'Attraction',
        domain: 'nps.gov',
  ...
  return (
    linkTemplates[city] || [
      {
        title: `${city} Hotels on Booking.com`,
        url: `https://www.booking.com/searchresults.html?ss=${encodeURIComponent(city)}`,
        category: 'Accommodation',
        domain: 'booking.com',
        description: `Find the best hotels in ${city}`,
      },
      {
        title: `${city} Activities on Viator`,
        url: `https://www.viator.com/searchResults/all?text=${encodeURIComponent(city)}`,
        category: 'Activity',
        domain: 'viator.com',
        description: `Tours and activities in ${city}`,
      },
      {
        title: `${city} Restaurants on Yelp`,
        url: `https://www.yelp.com/search?find_desc=Restaurants&find_loc=${encodeURIComponent(city)}`,
        category: 'Appetite',
        domain: 'yelp.com',
        description: `Best restaurants in ${city}`,
      },
      {
        title: `Things to do in ${city}`,
        url: `https://www.tripadvisor.com/Search?q=${encodeURIComponent(city)}`,
        category: 'Attraction',
        domain: 'tripadvisor.com',
        description: `Top attractions in ${city}`,
      },
    ]
  );
};
...
export const generateTripMockData = (tripOrId: Trip | number | string) => {
  ...
  const trip =
    typeof tripOrId === 'object' && tripOrId !== null
      ...
      : typeof tripId === 'number'
        ? getTripById(tripId)
        : getTripById(parseInt(String(tripId), 10));
  ...
  const generateMessages = () => {
    ...
    return messageTemplates.map((msg, idx) => ({
      ...
      authorAvatar:
        participants[msg.author % participants.length]?.avatar || getMockAvatar('Guest'),
      content: msg.content,
      time: msg.time,
    ...
    const mediaItems = [
      {
        ...
        uploadedBy: participants[0]?.name || 'Guest',
        date: 'Day 1',
      },
      {
        id: 2,
        ...
        uploadedBy: participants[1]?.name || 'Guest',
        date: 'Day 1',
      },
      {
        id: 3,
        ...
        uploadedBy: participants[2]?.name || 'Guest',
        date: 'Day 2',
      },
      {
        id: 4,
        type: 'photo',
        url: 'https://images.unsplash.com/photo-1530789253388-582c481c54b0?w=400',
        uploadedBy: participants[0]?.name || 'Guest',
        date: 'Day 2',
      },
      {
        ...
        uploadedBy: participants[3]?.name || 'Guest',
        date: 'Day 3',
      },
      {
        id: 6,
    ...
    const payments = [
      {
        ...
        amount: 1200,
        paidBy: participants[0]?.name || 'Guest',
        splitWith: participants.slice(0, 4).map(p => p.name),
        status: 'pending',
      },
      {
        id: 2,
        ...
        amount: 280,
        paidBy: participants[1]?.name || 'Guest',
        splitWith: participants.slice(0, 6).map(p => p.name),
        status: 'settled',
      },
      {
        id: 3,
        ...
        amount: 450,
        paidBy: participants[2]?.name || 'Guest',
        splitWith: participants.slice(0, 8).map(p => p.name),
        status: 'pending',
      },
      {
        id: 4,
        ...
        amount: 180,
        paidBy: participants[3]?.name || 'Guest',
        splitWith: participants.slice(0, 4).map(p => p.name),
        status: 'settled',
      },
    ];
