...
// NOTE (archival): this deployed source references ELEVENLABS_API_KEY without ever declaring it
// (only OPENAI_API_KEY / GOOGLE_* are read from env), so the function throws a ReferenceError
// at request time — preserved as-is from the live deployment.
