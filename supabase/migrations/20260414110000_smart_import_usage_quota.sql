-- Smart Import quota tracking (monthly, user+trip scoped; trip_id nullable for non-trip flows)
...
GRANT EXECUTE ON FUNCTION public.check_and_increment_smart_import_usage(UUID, UUID, INTEGER)
