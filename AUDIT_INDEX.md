...
|------|------|-------|-------------|-------|
| 2026-01-10 | APP_STORE_READINESS_AUDIT.md | iOS launch readiness — RevenueCat web billing (Capacitor sections predate 2026-05-12; native shell now lives in a separate repo) | 82/100 | 471 |
